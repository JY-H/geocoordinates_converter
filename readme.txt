readme.txt 
	...
	This is a script written to collect latitude/longitude coordinates for Punchlist’s data collection. 

	In order to use the script, please copy all the addresses for which you want the longtitude and latitude, into a single text file named "testing.txt" and put the text file in the same directory as the code. 
